...
public class BlockOrientableVerticalWithSubtypes extends BlockOrientableWithSubtypes
{
    public static final PropertyDirection FACING = BlockOrientableVertical.FACING;

    public BlockOrientableVerticalWithSubtypes(Material material, ContentBlockOrientable content)
    {
