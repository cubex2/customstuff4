...
public class ShiftClickRuleTest
{
    ...
    public void test_canApply() throws Exception
    {
        ...
        assertFalse(rule.canApply(-1, null));
        assertFalse(rule.canApply(4, null));
        assertFalse(rule.canApply(5, null));
        assertFalse(rule.canApply(10, null));
        assertFalse(rule.canApply(11, null));
        assertTrue(rule.canApply(0, null));
        assertTrue(rule.canApply(3, null));
    }
